...
public class Picture extends SimplePicture 
{
  ...
  public void myCollage() {
	  Picture flower1 = new Picture("flower1.jpg");
	    ...
	    Picture flowerNoBlue2 = new Picture(flower2);
	    flowerNoBlue2.zeroBlue();
	    this.copy(flowerNoBlue2,300,0);
	    this.copy(flower1,400,0);
	    this.copy(flower2,500,0);
	    this.copy(caterpillar, 600, 0);
	    Picture flowerGrayScale1 = new Picture(flower1);
	    flowerGrayScale1.grayscale();
	    this.copy(flowerGrayScale1, 700, 0);
	    this.copy(flower1, 800, 0);
	    this.copy(flower2, 900, 0);
	    this.copy(caterpillar, 1000, 0);
	    Picture caterpillarNegate = new Picture(caterpillar);
	    this.copy(caterpillarNegate, 1100, 0);
	    this.mirrorVertical();
	    this.write("collage.jpg");
  }
  ...
  public void fixUnderwater() {
	  ...
	  for (Pixel[] rowArray : pixels) {
		  for (Pixel pixelObj : rowArray) {
			  if (pixelObj.getRed() < 23 && pixelObj.getGreen() > 157) {
				  pixelObj.setRed(255);
				  pixelObj.setGreen(203);
				  pixelObj.setBlue(115);
			  }
		  }
	  }
  }
